...
public class RestaurantMenuBean {
    ...
    public String addMenuItem(){
        ...
        Object itemId = newRow.getAttribute("ItemId"); // Check if ItemId exists
        if (itemId == null) {
            // Assuming ItemId is generated by a sequence or some logic
            ViewObject seqVO = am.findViewObject("ItemIdSequenceVO"); // Assuming you have a sequence view object
            seqVO.executeQuery();
            Row seqRow = seqVO.first();
            if (seqRow != null) {
                Number newItemId = (Number) seqRow.getAttribute("SeqNumber");
                newRow.setAttribute("ItemId", newItemId);  // Set itemId from sequence
            }
        }
